...
class InventoryTest < ActiveSupport::TestCase
  def setup
    @inventory =  Inventory.create(name: "Montreal Warehouse", remark: "Montreal location heated has it gets very cold sometime")
  ...
  test "should increment by one if no count param is passed" do
    @record = Record.create(quantity: Faker::Number.non_zero_digit, inventory_item_id: @inventory_item.id, inventory_id: @inventory.id)
  ...
  test "should be able to extract total quantity" do
    ...
    @first_record = Record.create(quantity: Faker::Number.non_zero_digit, inventory_item_id: @inventory_item.id, inventory_id: @inventory.id)
    @second_record = Record.create(quantity: Faker::Number.non_zero_digit, inventory_item_id: @inventory_item_second.id, inventory_id: @inventory.id)
